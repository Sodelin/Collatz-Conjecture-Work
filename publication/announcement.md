...
The mathematical source is [3d9a74e79a2162472430537f4fe7aa299450271c](https://github.com/Sodelin/Collatz-Conjecture-Work/tree/3d9a74e79a2162472430537f4fe7aa299450271c). Every committed source file is preserved in research-source.zip. All tracked Lean sources, including three archived standalone derivations, are included in lean-source.zip with the pinned Lean4.33.1 configuration. The claim manifest and exact verification logs distinguish formal results, prose arguments, bounded searches, known reconstructions and open questions.
...
The [38-entry claim manifest](https://github.com/Sodelin/Collatz-Conjecture-Work/blob/3d9a74e79a2162472430537f4fe7aa299450271c/publication/claims.json), [claim registry](https://github.com/Sodelin/Collatz-Conjecture-Work/blob/3d9a74e79a2162472430537f4fe7aa299450271c/proof-search/CLAIM_REGISTRY.md), [verification index](https://github.com/Sodelin/Collatz-Conjecture-Work/blob/3d9a74e79a2162472430537f4fe7aa299450271c/verification/README.md), and [consolidation review](https://github.com/Sodelin/Collatz-Conjecture-Work/blob/3d9a74e79a2162472430537f4fe7aa299450271c/research-review/consolidation-2026-09-05/REPORT.md) supply exact paths, hypotheses and source identities. The two historical lemmas called L15 have different full titles. Conflicting failure IDs are reconciled without dropping either result. The old Thue–Morse membership target is preserved as a superseded derivation.

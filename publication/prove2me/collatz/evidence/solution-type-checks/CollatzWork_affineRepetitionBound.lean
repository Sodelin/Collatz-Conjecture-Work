import Lean
import Solutions.Sol_CollatzWork_affineRepetitionBound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.affineRepetitionBound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.affineRepetitionBound"),

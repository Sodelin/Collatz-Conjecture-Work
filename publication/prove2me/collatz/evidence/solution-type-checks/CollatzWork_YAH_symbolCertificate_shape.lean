import Lean
import Solutions.Sol_CollatzWork_YAH_symbolCertificate_shape
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.symbolCertificate_shape
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.symbolCertificate_shape"),

import Lean
import Solutions.Sol_BlindCollatz_RepetitionBound_affine_repetition_bound
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.RepetitionBound.affine_repetition_bound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.RepetitionBound.affine_repetition_bound"),

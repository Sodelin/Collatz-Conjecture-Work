import Lean
import Solutions.Sol_CollatzWork_firstContractionQuarterGap
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.firstContractionQuarterGap
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.firstContractionQuarterGap"),

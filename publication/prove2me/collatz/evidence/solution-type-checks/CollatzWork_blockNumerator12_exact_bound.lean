import Lean
import Solutions.Sol_CollatzWork_blockNumerator12_exact_bound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.blockNumerator12_exact_bound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.blockNumerator12_exact_bound"),

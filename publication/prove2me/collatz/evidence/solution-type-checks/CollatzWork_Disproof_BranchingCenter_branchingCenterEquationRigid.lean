import Lean
import Solutions.Sol_CollatzWork_Disproof_BranchingCenter_branchingCenterEquationRigid
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.BranchingCenter.branchingCenterEquationRigid
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.BranchingCenter.branchingCenterEquationRigid"),

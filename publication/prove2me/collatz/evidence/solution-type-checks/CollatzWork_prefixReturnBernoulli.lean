import Lean
import Solutions.Sol_CollatzWork_prefixReturnBernoulli
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.prefixReturnBernoulli
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.prefixReturnBernoulli"),

import Lean
import Solutions.Sol_CollatzWork_refinedParent_has_smaller_coalescence
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.refinedParent_has_smaller_coalescence
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.refinedParent_has_smaller_coalescence"),

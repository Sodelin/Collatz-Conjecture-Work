import Lean
import Solutions.Sol_CollatzWork_Disproof_FiniteResidueFirstIntegral_commutator_transitive_forces_constant
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.FiniteResidueFirstIntegral.commutator_transitive_forces_constant
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.FiniteResidueFirstIntegral.commutator_transitive_forces_constant"),

import Lean
import Solutions.Sol_CollatzWork_residueAncestor_tail38
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_tail38
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_tail38"),

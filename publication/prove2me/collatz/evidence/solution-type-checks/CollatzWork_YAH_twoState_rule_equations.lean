import Lean
import Solutions.Sol_CollatzWork_YAH_twoState_rule_equations
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.twoState_rule_equations
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.twoState_rule_equations"),

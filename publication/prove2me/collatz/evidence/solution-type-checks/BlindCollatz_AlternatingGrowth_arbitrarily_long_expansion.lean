import Lean
import Solutions.Sol_BlindCollatz_AlternatingGrowth_arbitrarily_long_expansion
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.AlternatingGrowth.arbitrarily_long_expansion
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.AlternatingGrowth.arbitrarily_long_expansion"),

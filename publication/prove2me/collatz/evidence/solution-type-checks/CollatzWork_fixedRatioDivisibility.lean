import Lean
import Solutions.Sol_CollatzWork_fixedRatioDivisibility
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.fixedRatioDivisibility
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.fixedRatioDivisibility"),

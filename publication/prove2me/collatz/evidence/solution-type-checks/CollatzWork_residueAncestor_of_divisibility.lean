import Lean
import Solutions.Sol_CollatzWork_residueAncestor_of_divisibility
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_of_divisibility
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_of_divisibility"),

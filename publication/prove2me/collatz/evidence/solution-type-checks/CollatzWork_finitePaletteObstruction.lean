import Lean
import Solutions.Sol_CollatzWork_finitePaletteObstruction
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.finitePaletteObstruction
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.finitePaletteObstruction"),

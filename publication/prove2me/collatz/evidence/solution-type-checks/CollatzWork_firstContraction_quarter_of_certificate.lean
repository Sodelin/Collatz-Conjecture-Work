import Lean
import Solutions.Sol_CollatzWork_firstContraction_quarter_of_certificate
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.firstContraction_quarter_of_certificate
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.firstContraction_quarter_of_certificate"),

import Lean
import Solutions.Sol_CollatzWork_YAH_unlabelledCertificate_shape
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.unlabelledCertificate_shape
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.unlabelledCertificate_shape"),

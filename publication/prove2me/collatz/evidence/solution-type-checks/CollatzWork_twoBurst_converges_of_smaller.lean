import Lean
import Solutions.Sol_CollatzWork_twoBurst_converges_of_smaller
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.twoBurst_converges_of_smaller
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.twoBurst_converges_of_smaller"),

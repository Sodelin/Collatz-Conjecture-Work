import Lean
import Solutions.Sol_CollatzWork_YAH_noTwoStateSymbolCertificateOrientation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.noTwoStateSymbolCertificateOrientation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.noTwoStateSymbolCertificateOrientation"),

import Lean
import Solutions.Sol_CollatzWork_converges_shortcutIter_iff
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.converges_shortcutIter_iff
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.converges_shortcutIter_iff"),

import Lean
import Solutions.Sol_CollatzWork_YAH_unlabelledCertificate_cancellation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.unlabelledCertificate_cancellation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.unlabelledCertificate_cancellation"),

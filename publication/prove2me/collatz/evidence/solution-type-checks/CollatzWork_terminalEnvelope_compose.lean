import Lean
import Solutions.Sol_CollatzWork_terminalEnvelope_compose
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.terminalEnvelope_compose
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.terminalEnvelope_compose"),

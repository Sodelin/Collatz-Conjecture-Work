import Lean
import Solutions.Sol_CollatzWork_excursionBudgetDescent
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.excursionBudgetDescent
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.excursionBudgetDescent"),

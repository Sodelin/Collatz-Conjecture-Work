import Lean
import Solutions.Sol_BlindCollatz_descent_iff_convergence
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.descent_iff_convergence
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.descent_iff_convergence"),

import Lean
import Solutions.Sol_CollatzWork_residueAncestor_tail173
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_tail173
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_tail173"),

import Lean
import Solutions.Sol_CollatzWork_parityPrefix_dvd_sub_of_le
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.parityPrefix_dvd_sub_of_le
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.parityPrefix_dvd_sub_of_le"),

import Lean
import Solutions.Sol_CollatzWork_Disproof_firstRotatedDeterminantCoefficients
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.firstRotatedDeterminantCoefficients
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.firstRotatedDeterminantCoefficients"),

import Lean
import Solutions.Sol_CollatzWork_refinedMersenneChild_coalesces
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.refinedMersenneChild_coalesces
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.refinedMersenneChild_coalesces"),

import Lean
import Solutions.Sol_CollatzWork_Disproof_twoPumpConstantObstructionVanishes
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.twoPumpConstantObstructionVanishes
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.twoPumpConstantObstructionVanishes"),

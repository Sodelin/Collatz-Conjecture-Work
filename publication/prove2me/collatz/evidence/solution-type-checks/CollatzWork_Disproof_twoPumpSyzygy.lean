import Lean
import Solutions.Sol_CollatzWork_Disproof_twoPumpSyzygy
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.twoPumpSyzygy
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.twoPumpSyzygy"),

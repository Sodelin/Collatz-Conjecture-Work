import Lean
import Solutions.Sol_CollatzWork_residueAncestor_factor_unit
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_factor_unit
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_factor_unit"),

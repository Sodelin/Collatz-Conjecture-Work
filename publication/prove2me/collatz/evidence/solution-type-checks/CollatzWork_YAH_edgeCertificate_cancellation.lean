import Lean
import Solutions.Sol_CollatzWork_YAH_edgeCertificate_cancellation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.edgeCertificate_cancellation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.edgeCertificate_cancellation"),

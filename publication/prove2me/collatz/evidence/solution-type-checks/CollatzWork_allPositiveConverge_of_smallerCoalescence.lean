import Lean
import Solutions.Sol_CollatzWork_allPositiveConverge_of_smallerCoalescence
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.allPositiveConverge_of_smallerCoalescence
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.allPositiveConverge_of_smallerCoalescence"),

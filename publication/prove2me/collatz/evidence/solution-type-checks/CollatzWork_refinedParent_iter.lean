import Lean
import Solutions.Sol_CollatzWork_refinedParent_iter
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.refinedParent_iter
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.refinedParent_iter"),

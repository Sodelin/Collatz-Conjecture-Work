import Lean
import Solutions.Sol_CollatzWork_affineQuarterCertificate
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.affineQuarterCertificate
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.affineQuarterCertificate"),

import Lean
import Solutions.Sol_BlindCollatz_RepetitionBound_telescope
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.RepetitionBound.telescope
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.RepetitionBound.telescope"),

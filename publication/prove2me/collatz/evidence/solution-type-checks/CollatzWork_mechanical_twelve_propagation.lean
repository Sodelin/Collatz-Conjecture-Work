import Lean
import Solutions.Sol_CollatzWork_mechanical_twelve_propagation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mechanical_twelve_propagation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mechanical_twelve_propagation"),

import Lean
import Solutions.Sol_CollatzWork_mechanical_fifteen_failure
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mechanical_fifteen_failure
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mechanical_fifteen_failure"),

import Lean
import Solutions.Sol_CollatzWork_noInfiniteExpandingAffineBlocks
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.noInfiniteExpandingAffineBlocks
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.noInfiniteExpandingAffineBlocks"),

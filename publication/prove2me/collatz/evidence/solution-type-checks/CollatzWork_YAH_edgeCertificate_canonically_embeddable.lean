import Lean
import Solutions.Sol_CollatzWork_YAH_edgeCertificate_canonically_embeddable
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.edgeCertificate_canonically_embeddable
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.edgeCertificate_canonically_embeddable"),

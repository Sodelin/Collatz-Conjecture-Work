import Lean
import Solutions.Sol_CollatzWork_firstContractionTime
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.firstContractionTime
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.firstContractionTime"),

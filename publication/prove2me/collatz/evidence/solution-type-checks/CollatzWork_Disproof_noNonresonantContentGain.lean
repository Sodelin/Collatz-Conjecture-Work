import Lean
import Solutions.Sol_CollatzWork_Disproof_noNonresonantContentGain
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.noNonresonantContentGain
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.noNonresonantContentGain"),

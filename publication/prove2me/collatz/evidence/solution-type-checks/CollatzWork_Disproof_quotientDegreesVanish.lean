import Lean
import Solutions.Sol_CollatzWork_Disproof_quotientDegreesVanish
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.quotientDegreesVanish
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.quotientDegreesVanish"),

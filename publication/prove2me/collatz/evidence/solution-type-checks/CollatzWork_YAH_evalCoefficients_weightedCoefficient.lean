import Lean
import Solutions.Sol_CollatzWork_YAH_evalCoefficients_weightedCoefficient
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.evalCoefficients_weightedCoefficient
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.evalCoefficients_weightedCoefficient"),

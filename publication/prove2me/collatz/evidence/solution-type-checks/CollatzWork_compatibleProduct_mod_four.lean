import Lean
import Solutions.Sol_CollatzWork_compatibleProduct_mod_four
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.compatibleProduct_mod_four
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.compatibleProduct_mod_four"),

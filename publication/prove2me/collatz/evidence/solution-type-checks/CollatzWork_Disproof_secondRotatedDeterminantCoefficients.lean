import Lean
import Solutions.Sol_CollatzWork_Disproof_secondRotatedDeterminantCoefficients
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.secondRotatedDeterminantCoefficients
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.secondRotatedDeterminantCoefficients"),

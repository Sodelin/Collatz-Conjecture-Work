import Lean
import Solutions.Sol_CollatzWork_YAH_symbolCertificate_cancellation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.symbolCertificate_cancellation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.symbolCertificate_cancellation"),

import Lean
import Solutions.Sol_CollatzWork_noInfinitePositiveRecurrence
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.noInfinitePositiveRecurrence
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.noInfinitePositiveRecurrence"),

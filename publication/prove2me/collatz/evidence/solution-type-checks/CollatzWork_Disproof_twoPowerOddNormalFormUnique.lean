import Lean
import Solutions.Sol_CollatzWork_Disproof_twoPowerOddNormalFormUnique
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.twoPowerOddNormalFormUnique
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.twoPowerOddNormalFormUnique"),

import Lean
import Solutions.Sol_CollatzWork_affineRecurrenceTelescope
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.affineRecurrenceTelescope
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.affineRecurrenceTelescope"),

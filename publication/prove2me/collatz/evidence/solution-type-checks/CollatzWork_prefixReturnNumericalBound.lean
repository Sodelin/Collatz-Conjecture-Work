import Lean
import Solutions.Sol_CollatzWork_prefixReturnNumericalBound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.prefixReturnNumericalBound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.prefixReturnNumericalBound"),

import Lean
import Solutions.Sol_CollatzWork_finitePalette_path_obstruction
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.finitePalette_path_obstruction
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.finitePalette_path_obstruction"),

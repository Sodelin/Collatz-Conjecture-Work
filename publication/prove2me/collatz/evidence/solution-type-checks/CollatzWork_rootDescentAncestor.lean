import Lean
import Solutions.Sol_CollatzWork_rootDescentAncestor
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.rootDescentAncestor
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.rootDescentAncestor"),

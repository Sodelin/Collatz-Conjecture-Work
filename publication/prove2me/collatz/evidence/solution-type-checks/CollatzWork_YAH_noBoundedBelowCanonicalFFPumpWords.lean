import Lean
import Solutions.Sol_CollatzWork_YAH_noBoundedBelowCanonicalFFPumpWords
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.noBoundedBelowCanonicalFFPumpWords
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.noBoundedBelowCanonicalFFPumpWords"),

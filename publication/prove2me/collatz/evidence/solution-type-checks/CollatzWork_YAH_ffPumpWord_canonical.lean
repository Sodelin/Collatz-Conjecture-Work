import Lean
import Solutions.Sol_CollatzWork_YAH_ffPumpWord_canonical
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.ffPumpWord_canonical
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.ffPumpWord_canonical"),

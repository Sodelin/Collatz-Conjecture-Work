import Lean
import Solutions.Sol_CollatzWork_YAH_noTwoStateEdgeAdditiveOrder
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.noTwoStateEdgeAdditiveOrder
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.noTwoStateEdgeAdditiveOrder"),

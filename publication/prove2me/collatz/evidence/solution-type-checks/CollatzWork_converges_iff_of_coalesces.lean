import Lean
import Solutions.Sol_CollatzWork_converges_iff_of_coalesces
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.converges_iff_of_coalesces
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.converges_iff_of_coalesces"),

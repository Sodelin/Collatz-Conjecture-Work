import Lean
import Solutions.Sol_CollatzWork_Disproof_BranchingCenter_centerTwoPowerOddNormalFormUnique
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.BranchingCenter.centerTwoPowerOddNormalFormUnique
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.BranchingCenter.centerTwoPowerOddNormalFormUnique"),

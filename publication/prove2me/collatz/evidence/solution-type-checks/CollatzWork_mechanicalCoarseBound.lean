import Lean
import Solutions.Sol_CollatzWork_mechanicalCoarseBound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mechanicalCoarseBound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mechanicalCoarseBound"),

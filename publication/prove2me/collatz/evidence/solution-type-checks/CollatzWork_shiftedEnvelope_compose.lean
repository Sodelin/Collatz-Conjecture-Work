import Lean
import Solutions.Sol_CollatzWork_shiftedEnvelope_compose
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.shiftedEnvelope_compose
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.shiftedEnvelope_compose"),

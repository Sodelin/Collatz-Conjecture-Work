import Lean
import Solutions.Sol_BlindCollatz_AlternatingGrowth_shortcut_three_eq_ordinary_five
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.AlternatingGrowth.shortcut_three_eq_ordinary_five
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.AlternatingGrowth.shortcut_three_eq_ordinary_five"),

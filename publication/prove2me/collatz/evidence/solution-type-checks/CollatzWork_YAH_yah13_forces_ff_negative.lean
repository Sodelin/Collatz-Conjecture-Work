import Lean
import Solutions.Sol_CollatzWork_YAH_yah13_forces_ff_negative
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.yah13_forces_ff_negative
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.yah13_forces_ff_negative"),

import Lean
import Solutions.Sol_CollatzWork_mechanical_large_bound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mechanical_large_bound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mechanical_large_bound"),

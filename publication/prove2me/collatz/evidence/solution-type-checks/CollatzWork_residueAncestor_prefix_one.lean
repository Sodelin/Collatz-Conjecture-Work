import Lean
import Solutions.Sol_CollatzWork_residueAncestor_prefix_one
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_prefix_one
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_prefix_one"),

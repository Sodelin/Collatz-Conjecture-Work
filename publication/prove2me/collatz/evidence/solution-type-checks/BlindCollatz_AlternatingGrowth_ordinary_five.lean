import Lean
import Solutions.Sol_BlindCollatz_AlternatingGrowth_ordinary_five
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.AlternatingGrowth.ordinary_five
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.AlternatingGrowth.ordinary_five"),

import Lean
import Solutions.Sol_CollatzWork_residueAncestor_tail65
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_tail65
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_tail65"),

import Lean
import Solutions.Sol_CollatzWork_excursionChain_converges_of_smaller
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.excursionChain_converges_of_smaller
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.excursionChain_converges_of_smaller"),

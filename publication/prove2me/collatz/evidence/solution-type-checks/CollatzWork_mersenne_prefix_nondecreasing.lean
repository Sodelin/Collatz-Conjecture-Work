import Lean
import Solutions.Sol_CollatzWork_mersenne_prefix_nondecreasing
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mersenne_prefix_nondecreasing
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mersenne_prefix_nondecreasing"),

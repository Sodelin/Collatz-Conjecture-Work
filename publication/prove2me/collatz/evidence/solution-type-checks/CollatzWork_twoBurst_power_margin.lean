import Lean
import Solutions.Sol_CollatzWork_twoBurst_power_margin
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.twoBurst_power_margin
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.twoBurst_power_margin"),

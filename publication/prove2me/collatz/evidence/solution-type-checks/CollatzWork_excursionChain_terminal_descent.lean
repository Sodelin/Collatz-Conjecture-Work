import Lean
import Solutions.Sol_CollatzWork_excursionChain_terminal_descent
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.excursionChain_terminal_descent
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.excursionChain_terminal_descent"),

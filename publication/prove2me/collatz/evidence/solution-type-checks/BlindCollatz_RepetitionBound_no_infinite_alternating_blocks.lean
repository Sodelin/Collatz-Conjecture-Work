import Lean
import Solutions.Sol_BlindCollatz_RepetitionBound_no_infinite_alternating_blocks
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.RepetitionBound.no_infinite_alternating_blocks
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.RepetitionBound.no_infinite_alternating_blocks"),

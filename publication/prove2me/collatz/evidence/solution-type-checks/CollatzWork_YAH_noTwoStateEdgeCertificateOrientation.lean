import Lean
import Solutions.Sol_CollatzWork_YAH_noTwoStateEdgeCertificateOrientation
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.noTwoStateEdgeCertificateOrientation
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.noTwoStateEdgeCertificateOrientation"),

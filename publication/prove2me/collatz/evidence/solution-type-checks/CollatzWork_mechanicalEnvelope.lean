import Lean
import Solutions.Sol_CollatzWork_mechanicalEnvelope
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.mechanicalEnvelope
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.mechanicalEnvelope"),

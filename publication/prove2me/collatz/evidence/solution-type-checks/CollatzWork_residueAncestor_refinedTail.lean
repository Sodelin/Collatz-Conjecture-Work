import Lean
import Solutions.Sol_CollatzWork_residueAncestor_refinedTail
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_refinedTail
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_refinedTail"),

import Lean
import Solutions.Sol_CollatzWork_YAH_noTwoStateSymbolAdditiveOrder
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.noTwoStateSymbolAdditiveOrder
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.noTwoStateSymbolAdditiveOrder"),

import Lean
import Solutions.Sol_CollatzWork_residueAncestor_normalized
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_normalized
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_normalized"),

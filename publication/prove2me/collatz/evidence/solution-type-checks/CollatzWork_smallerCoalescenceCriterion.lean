import Lean
import Solutions.Sol_CollatzWork_smallerCoalescenceCriterion
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.smallerCoalescenceCriterion
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.smallerCoalescenceCriterion"),

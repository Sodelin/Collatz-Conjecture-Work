import Lean
import Solutions.Sol_CollatzWork_excursionChainEnvelope
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.excursionChainEnvelope
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.excursionChainEnvelope"),

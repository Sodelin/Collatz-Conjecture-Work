import Lean
import Solutions.Sol_BlindCollatz_RepetitionBound_alternating_repetition_bound
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.RepetitionBound.alternating_repetition_bound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.RepetitionBound.alternating_repetition_bound"),

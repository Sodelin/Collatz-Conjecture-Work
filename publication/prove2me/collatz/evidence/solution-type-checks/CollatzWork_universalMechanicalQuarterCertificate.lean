import Lean
import Solutions.Sol_CollatzWork_universalMechanicalQuarterCertificate
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.universalMechanicalQuarterCertificate
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.universalMechanicalQuarterCertificate"),

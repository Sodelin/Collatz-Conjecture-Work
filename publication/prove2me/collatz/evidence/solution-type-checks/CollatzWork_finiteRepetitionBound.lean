import Lean
import Solutions.Sol_CollatzWork_finiteRepetitionBound
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.finiteRepetitionBound
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.finiteRepetitionBound"),

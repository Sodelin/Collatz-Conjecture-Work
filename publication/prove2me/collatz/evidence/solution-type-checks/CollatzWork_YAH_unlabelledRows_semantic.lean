import Lean
import Solutions.Sol_CollatzWork_YAH_unlabelledRows_semantic
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.unlabelledRows_semantic
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.unlabelledRows_semantic"),

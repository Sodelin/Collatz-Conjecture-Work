import Lean
import Solutions.Sol_CollatzWork_Disproof_twoPumpCoefficientDependencies
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.Disproof.twoPumpCoefficientDependencies
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.Disproof.twoPumpCoefficientDependencies"),

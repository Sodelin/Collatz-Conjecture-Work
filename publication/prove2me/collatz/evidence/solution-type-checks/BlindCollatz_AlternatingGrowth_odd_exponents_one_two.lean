import Lean
import Solutions.Sol_BlindCollatz_AlternatingGrowth_odd_exponents_one_two
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.AlternatingGrowth.odd_exponents_one_two
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.AlternatingGrowth.odd_exponents_one_two"),

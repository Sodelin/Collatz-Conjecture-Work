import Lean
import Solutions.Sol_BlindCollatz_AlternatingGrowth_goodBlocks_each_block_grows
...
run_meta do
  ...
  let ti ← getConstInfo `BlindCollatz.AlternatingGrowth.goodBlocks_each_block_grows
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "BlindCollatz.AlternatingGrowth.goodBlocks_each_block_grows"),

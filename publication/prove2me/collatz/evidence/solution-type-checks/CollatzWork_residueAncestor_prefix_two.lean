import Lean
import Solutions.Sol_CollatzWork_residueAncestor_prefix_two
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.residueAncestor_prefix_two
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.residueAncestor_prefix_two"),

import Lean
import Solutions.Sol_CollatzWork_firstContractionThirdGap
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.firstContractionThirdGap
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.firstContractionThirdGap"),

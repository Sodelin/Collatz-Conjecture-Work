import Lean
import Solutions.Sol_CollatzWork_YAH_weightedGapSum_pos
...
run_meta do
  ...
  let ti ← getConstInfo `CollatzWork.YAH.weightedGapSum_pos
  ...
  let tty ← ppExpr tt
  let row := Json.mkObj [
    ("theorem_name", toJson "CollatzWork.YAH.weightedGapSum_pos"),

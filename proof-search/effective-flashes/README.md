...
|---|---|---|
| [Reciprocal summability](issue-7-reciprocal-summability.md) | [Issue #7](https://github.com/Sodelin/Collatz-Conjecture-Work/issues/7) | Source and map bridge verified; attributed corollary with existing public overlap; independent novelty not promoted. |

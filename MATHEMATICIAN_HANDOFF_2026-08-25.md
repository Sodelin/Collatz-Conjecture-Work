...
Classification: **`STOPPED-USEFUL / FINITE-WINDOW CLASS CLOSED / NO PROOF OR DISPROOF`**. Finite prime-return, roughness, or bounded-window restrictions do
...
Classification: **`PROVED_AUX / GLOBAL REALIZABILITY GATE / UNRESOLVED BRANCH`**. The exact converse/dichotomy was not located in the bounded source
...
- [`C-TM-MAHLER-ANCHOR-001`](proof-search/disproof/CODEX_TM_MAHLER_ANCHOR_2026-08-24.md)
  ...
  **`PAUSED_AWAITING_EXACT_2_ADIC_MEMBERSHIP / NO DISPROOF / DO NOT CITE AS A COUNTEREXAMPLE`**.
